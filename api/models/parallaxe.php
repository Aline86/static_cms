...
class Parallaxe {
    ...
    public  function get_parallaxe($parameters)
    {
    ...
    public  function add_parallaxe($parameters)
    {
    ...
    public  function delete_parallaxe($parameters)
    {     
        include 'model_snippets/delete.php';  ;   
    }
   
    public  function update_parallaxe($parameters)
    {  
